                            ...
                            <div class="table-responsive">
                                <form action="{{ route('produk.update',$produk->id_produk) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <input type="text" class="form-control" name="merk" id="merk" value={{ $produk->merk }}>
                                    </div>
                                    <div class="mb-3">
                                        <label for="jenis_kelamin" class="form-label">JENIS KELAMIN</label>
                                        <select id="jenis_kelamin" name="jenis_kelamin" class="form-select">
                                          <option value="Laki-Laki"{{ old('jenis_kelamin',$produk->nama_produk)=='Laki-Laki'?'selected' : '' }}>Laki-Laki</option>
                                          <option value="Perempuan"{{ old('jenis_kelamin',$produk->nama_produk)=='Perempuan'?'selected' : '' }}>Perempuan</option>
                                        </select>
                                    </div>  
                                    <div class="mb-3">
